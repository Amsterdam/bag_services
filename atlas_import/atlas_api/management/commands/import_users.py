...
from datasets.akr import models as akr_models
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        view_sensitive_details_permission_akr = Permission.objects.get(
            content_type=ContentType.objects.get_for_model(akr_models.KadastraalSubject),
        ...
        with open(csv_file) as f:
            ...
            for row in reader:
                ...
                user.user_permissions.add(view_sensitive_details_permission_akr)
