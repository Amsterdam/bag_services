...
router.register(r'bag/gebiedsgerichtwerken', datasets.bag.views.GebiedsgerichtwerkenViewSet)

router.register(r'gebieden/gemeente', datasets.bag.views.GemeenteViewSet)
