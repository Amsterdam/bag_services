...
router.register(r'bag/stadsdeel', datasets.bag.views.StadsdeelViewSet)
router.register(r'bag/buurt', datasets.bag.views.BuurtViewSet)
router.register(r'bag/bouwblok', datasets.bag.views.BouwblokViewSet)
