...
class Migration(migrations.Migration):
    ...
    operations = [
        migrate.ManageView(view_name="geo_bag_stadsdeel",
                           sql="SELECT id, geometrie FROM bag_stadsdeel"),
        migrate.ManageView(view_name="geo_bag_buurt",
                           sql="SELECT id, geometrie FROM bag_buurt"),
        migrate.ManageView(view_name="geo_bag_bouwblok",
                           sql="SELECT id, geometrie FROM bag_bouwblok"),
        migrate.ManageView(view_name="geo_bag_buurtcombinatie",
                           sql="SELECT id, geometrie FROM bag_buurtcombinatie"),
        migrate.ManageView(view_name="geo_bag_gebiedsgerichtwerken",
                           sql="SELECT id, geometrie FROM bag_gebiedsgerichtwerken"),
        migrate.ManageView(view_name="geo_bag_grootstedelijkproject",
                           sql="SELECT id, geometrie FROM bag_grootstedelijkproject"),
        migrate.ManageView(view_name="geo_bag_unesco",
                           sql="SELECT id, geometrie FROM bag_unesco"),
    ]
