...
class DenormalizeDataTaskTest(TransactionTestCase):
    ...
    def setUp(self):
        ...
        self.num_1n = factories.NummeraanduidingFactory.create(
            openbare_ruimte=self.opr_1,
            hoofdadres=False,
            verblijfsobject=self.vbo_1,
        )
        self.num_1h = factories.NummeraanduidingFactory.create(
            openbare_ruimte=self.opr_1,
            hoofdadres=True,
            verblijfsobject=self.vbo_1,
        )
        self.num_2 = factories.NummeraanduidingFactory.create(
            openbare_ruimte=self.opr_2,
            hoofdadres=True,
    ...
    def test_normalize_vbo(self):
        ...
        self.assertEqual(vbo_1._huisnummer, self.num_1h.huisnummer)
        self.assertEqual(vbo_1._huisletter, self.num_1h.huisletter)
        self.assertEqual(vbo_1._huisnummer_toevoeging, self.num_1h.huisnummer_toevoeging)
