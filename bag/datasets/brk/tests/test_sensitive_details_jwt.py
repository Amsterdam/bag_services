...
class SensitiveDetailsJwtTestCase(APITestCase):
    ...
    def test_niet_ingelogd_geen_details_in_natuurlijk_persoon_json(self):
        response = self.client.get(
            '/brk/subject/{}/'.format(self.natuurlijk.pk)).data
    ...
    def test_niet_ingelogd_wel_details_in_niet_natuurlijk_persoon_json(self):
        response = self.client.get(
            '/brk/subject/{}/'.format(self.niet_natuurlijk.pk)).data
    ...
    def test_ingelogd_wel_geautoriseed_wel_details_in_natuurlijk_persoon_json(
            self):
        self.client.credentials(
    ...
    def test_uitgelogd_zakelijk_recht_niet_natuurlijk_verwijst_naar_hoofd_view(
            self):
        response = self.client.get('/brk/zakelijk-recht/{}/'.format(
    ...
    def test_uitgelogd_zakelijk_recht_natuurlijk_verwijst_naar_subresource(
            self):
        response = self.client.get(
            '/brk/zakelijk-recht/{}/'.format(self.recht_natuurlijk.pk)).data
    ...
    def test_subresource_toon_persoonsgegevens_maar_geen_relaties(self):
        response = self.client.get('/brk/zakelijk-recht/{}/subject/'.format(
    ...
    def test_directional_name_subject(self):
        ...
        self.assertTrue(
            self.recht_natuurlijk._kadastraal_subject_naam in subj[
                '_display'] or
            self.recht_niet_natuurlijk._kadastraal_subject_naam in subj[
                '_display']
        )
