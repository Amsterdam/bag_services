        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(serialize=False, primary_key=True,
                                        default=uuid.uuid4)),
                ('a_perceel', models.ForeignKey(to='brk.KadastraalObject',
                                                related_name='g_perceel_relaties')),
                ('g_perceel', models.ForeignKey(to='brk.KadastraalObject',
                                                related_name='a_perceel_relaties')),
            ],
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='a_percelen',
                                         ...
                                         through='brk.APerceelGPerceelRelatie'),
        ),
    ]
