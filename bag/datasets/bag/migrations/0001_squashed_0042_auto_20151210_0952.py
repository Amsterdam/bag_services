...
class Migration(migrations.Migration):
    replaces = [('bag', '0001_initial'), ('bag', '0002_auto_20150908_1131'),
                ...
                ('bag', '0009_auto_20151020_1804'), ('bag',
                                                     '0010_buurtcombinatie_gebiedsgerichtwerken_grootstedelijkproject_unesco'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.CharField(primary_key=True, serialize=False,
                                        max_length=14)),
                ('landelijk_id',
                 models.CharField(max_length=16, unique=True, null=True)),
                ('vervallen', models.BooleanField(default=False)),
                ('geometrie',
                ...
                ('buurt',
                 models.ForeignKey(to='bag.Buurt', related_name='ligplaatsen',
                                   null=True)),
            ],
            options={
                'ordering': (
                '_openbare_ruimte_naam', '_huisnummer', '_huisletter',
                '_huisnummer_toevoeging'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bron', models.ForeignKey(to='bag.Bron', null=True)),
                ('ligplaats',
                 models.ForeignKey(to='bag.Ligplaats', related_name='adressen',
                                   null=True)),
            ],
            options={
                'ordering': (
                'openbare_ruimte__naam', 'huisnummer', 'huisletter',
                'huisnummer_toevoeging'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('landelijk_id',
                 models.CharField(max_length=16, unique=True, null=True)),
                ('type', models.CharField(max_length=2, choices=[('01', 'Weg'),
                                                                 (
                                                                 '02', 'Water'),
                                                                 ('03',
                                                                  'Spoorbaan'),
            ...
            fields=[
                ...
                ('geometrie',
                 django.contrib.gis.db.models.fields.PolygonField(srid=28992,
                                                                  null=True)),
                ('bouwblok',
                 models.ForeignKey(to='bag.Bouwblok', related_name='panden',
                                   null=True)),
            ],
            options={
                'verbose_name': 'Pand',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brondocument_naam',
                 models.CharField(max_length=100, null=True)),
                ('brondocument_datum', models.DateField(null=True)),
                ('gemeente', models.ForeignKey(related_name='stadsdelen',
                                               to='bag.Gemeente')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bron', models.ForeignKey(to='bag.Bron', null=True)),
                ('buurt',
                 models.ForeignKey(to='bag.Buurt', related_name='standplaatsen',
                                   null=True)),
            ],
            options={
                'ordering': (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_huisnummer_toevoeging',
                 models.CharField(max_length=4, null=True)),
                ('bron', models.ForeignKey(to='bag.Bron', null=True)),
                ('buurt', models.ForeignKey(to='bag.Buurt',
                                            related_name='verblijfsobjecten',
                                            null=True)),
                ('eigendomsverhouding',
                 models.ForeignKey(to='bag.Eigendomsverhouding', null=True)),
                ('financieringswijze',
                 models.ForeignKey(to='bag.Financieringswijze', null=True)),
                ('gebruik', models.ForeignKey(to='bag.Gebruik', null=True)),
                ('ligging', models.ForeignKey(to='bag.Ligging', null=True)),
                ('locatie_ingang',
                 models.ForeignKey(to='bag.LocatieIngang', null=True)),
            ],
            options={
                'ordering': (
                '_openbare_ruimte_naam', '_huisnummer', '_huisletter',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vervallen', models.BooleanField(default=False)),
                ('gemeente', models.ForeignKey(related_name='woonplaatsen',
                                               to='bag.Gemeente')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='panden',
            field=models.ManyToManyField(to='bag.Pand',
        ...
        migrations.AddField(
            model_name='openbareruimte',
            name='woonplaats',
            field=models.ForeignKey(related_name='openbare_ruimtes',
                                    to='bag.Woonplaats'),
        ),
        migrations.AddField(
            model_name='nummeraanduiding',
            name='openbare_ruimte',
            field=models.ForeignKey(related_name='adressen',
                                    to='bag.OpenbareRuimte'),
        ),
        migrations.AddField(
            model_name='nummeraanduiding',
            name='standplaats',
            field=models.ForeignKey(to='bag.Standplaats',
                                    related_name='adressen', null=True),
        ),
        migrations.AddField(
            model_name='nummeraanduiding',
            name='status',
        ...
        migrations.AddField(
            model_name='nummeraanduiding',
            name='verblijfsobject',
            field=models.ForeignKey(to='bag.Verblijfsobject',
                                    related_name='adressen', null=True),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='stadsdeel',
            field=models.ForeignKey(related_name='gebiedsgerichtwerken',
                                    to='bag.Stadsdeel'),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(to='bag.Stadsdeel',
                                    related_name='buurtcombinaties', null=True),
        ),
        migrations.AddField(
            model_name='buurt',
            name='buurtcombinatie',
            field=models.ForeignKey(to='bag.Buurtcombinatie',
                                    related_name='buurten', null=True),
        ),
        migrations.AddField(
            model_name='buurt',
            name='stadsdeel',
        ...
        migrations.AddField(
            model_name='bouwblok',
            name='buurt',
            field=models.ForeignKey(to='bag.Buurt', related_name='bouwblokken',
                                    null=True),
        ),
        migrations.AlterIndexTogether(
            name='verblijfsobject',
            index_together=set([('_openbare_ruimte_naam', '_huisnummer',
