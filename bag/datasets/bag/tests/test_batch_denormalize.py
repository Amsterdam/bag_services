...
class DenormalizeDataTaskTest(TransactionTestCase):
    ...
    def test_normalize_vbo(self):
        ...
        self.assertEqual(vbo_1._huisnummer_toevoeging,
                         self.num_vbo_1_hfd.huisnummer_toevoeging)
    ...
    def test_normalize_lig(self):
        ...
        self.assertEqual(lig_1._huisnummer_toevoeging,
                         self.num_lig_1_hfd.huisnummer_toevoeging)
    ...
    def test_normalize_sta(self):
        ...
        self.assertEqual(sta_1._huisnummer_toevoeging,
                         self.num_sta_1_hfd.huisnummer_toevoeging)
