...
TABLE_TARGETS = [
    ...
    (524254, 0, "bag_nummeraanduiding"),
    (6293, 0, "bag_openbareruimte"),
    (184377, 0, "bag_pand"),
    # (8         ,20 ,"bag_redenafvoer"),
    # (18        ,20 ,"bag_redenopvoer"),
    (8, 0, "bag_stadsdeel"),
